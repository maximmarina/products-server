...
class UsersController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('TestProjectsBundle:Users')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('Test\ProjectsBundle\Form\UsersType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('Test\ProjectsBundle\Form\UsersType', $user);
