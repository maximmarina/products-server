...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('TestProjectsBundle:Products')->findAll();
    ...
    {
        $product = new Product();
        $form = $this->createForm('Test\ProjectsBundle\Form\ProductsType', $product);
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('Test\ProjectsBundle\Form\ProductsType', $product);
