...
use Test\ProjectsBundle\Entity\Categories;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('TestProjectsBundle:Categories')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Test\ProjectsBundle\Form\CategoriesType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('Test\ProjectsBundle\Form\CategoriesType', $category);
